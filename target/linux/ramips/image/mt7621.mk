...
define Device/invendis_silbo-RK5X
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RK5X
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RK5X

define Device/invendis_silbo-RN50
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RN50
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RN50

define Device/invendis_silbo-RS5X
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RS5X
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RS5X

define Device/invendis_silbo-RG04
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RG04
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RG04

define Device/invendis_silbo-RU00
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RU00
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RU00

define Device/invendis_silbo-RV00
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RV00
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RV00

define Device/invendis_silbo-RVW50
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RVW50
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RVW50

define Device/invendis_silbo-RV54-2
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RV54-2
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RV54-2

define Device/invendis_silbo-RV54-1
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RV54-1
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RV54-1

define Device/invendis_silbo-RV04
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := invendis
  DEVICE_MODEL := silbo-RV04
  DEVICE_PACKAGES := kmod-sdhci-mt7620 kmod-usb3 \
	kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += invendis_silbo-RV04
