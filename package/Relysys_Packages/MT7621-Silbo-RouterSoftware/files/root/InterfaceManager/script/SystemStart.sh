...
UpdateFirewallConfig()
{
	...
	then 
		...
		uci delete firewall.wifi5wifiwan > /dev/null 2>&1
		uci delete firewall.gwifiwifiwan > /dev/null 2>&1
		uci delete firewall.gwifi5wifiwan > /dev/null 2>&1
		...
		#2.4GHZ
			...
			then
				...
				uci set firewall.gwifiwifiwan=forwarding
				uci set firewall.gwifiwifiwan.src="$wifiap1"
				uci set firewall.gwifiwifiwan.dest="$wifiwaninterface"
			fi
		else
			uci delete firewall.gwifi > /dev/null 2>&1
			uci delete firewall.gwifiwifiwan > /dev/null 2>&1
		...
		#5GHZ
			...
			then
				...
				uci set firewall.gwifi5wifiwan=forwarding
				uci set firewall.gwifi5wifiwan.src="$wifiap51"
				uci set firewall.gwifi5wifiwan.dest="$wifiwaninterface"
			fi
		else
			uci delete firewall.gwifi5 > /dev/null 2>&1
			uci delete firewall.gwifi5wifiwan > /dev/null 2>&1
		...
		then
			...
			uci set firewall.wifiwifiwan.src="$wifiinterface"
			uci set firewall.wifiwifiwan.dest="$wifiwaninterface"
			
			uci set firewall.wifi5wifiwan=forwarding
			uci set firewall.wifi5wifiwan.src="$wifi5interface"
			uci set firewall.wifi5wifiwan.dest="$wifiwaninterface"
