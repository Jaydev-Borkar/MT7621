	...
	var ui_class = {
		...
		firmwareUpload: function(title, content, options)
		{
			var state = L.ui._upload || (L.ui._upload = {
				...
				finish_cb: function(ev) {
					$(this).off('load');
					console.log(options.uploadedFileName);
...
if(_tag =="WAN-Status"){
      _tag ="<p><img src='/luci2/icons/Internet.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
...
if(_tag =="Wifi MacID Filtering"){
      _tag ="<p><img src='/luci2/icons/wifi.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
...
if(_tag == "Static Routing"){
      _tag ="<p><img src='/luci2/icons/static_routing.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }  
if(_tag == "BGP"){
      _tag ="<p><img src='/luci2/icons/bgp.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "OSPF"){
      _tag ="<p><img src='/luci2/icons/ospf.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "VLAN"){
       _tag ="<p><img src='/luci2/icons/switch.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Traffic Shaping"){
       _tag ="<p><img src='/luci2/icons/sqm.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag == "Dynamic Custom File"){
      _tag ="<p><img src='/luci2/icons/customfileupload.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }  
if(_tag == "Routing Debug"){
      _tag ="<p><img src='/luci2/icons/routingdebug.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
if(_tag =="SNMP Agent Configuration"){                 
      _tag ="<p><img src='/luci2/icons/RouterAp.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  }
if(_tag =="Captive Portal"){                 
      _tag ="<p><img src='/luci2/icons/captive_portal.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  }
if(_tag == "Custom Config"){
    _tag ="<p><img src='/luci2/icons/upload.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>"; 
 }
if(_tag =="Scheduled Tasks"){                 
      _tag ="<p><img src='/luci2/icons/Maint.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  }
if(_tag =="VRRP"){                 
      _tag ="<p><img src='/luci2/icons/bridge.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  }
if(_tag =="Multi-WAN"){                   
      _tag ="<p><img src='/luci2/icons/Internet.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";
  }
