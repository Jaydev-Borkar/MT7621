	L.ui.view.extend({
        ...
        updatefirewallconfig: L.rpc.declare({
                object: 'rpc-updatewirelessmacfilter',
                method: 'configure',
                expect: { output: '' }
        }),
        ...
        MACFilteringConfigSectionAdd: function (id) {
                ...
                this.MACFilteringUCISections("wirelessmacfilter", "wirelessmacfilter").then(function (rv) {
                        ...
                        if (keysLength >= 15) {
                                ...
                                if (id != "") {
                                        ...
                                        console.log(key);
                                        self.MACFilteringDeleteUCISection("wirelessmacfilter", "wirelessmacfilter", id).then(function (rv) {
                                                if (rv == 0) {
                                                        self.MACFilteringCommitUCISection("wirelessmacfilter").then(function (res) {
                                                                if (res != 0) {
                                        ...
                                        self.MACFilteringCreateUCISection("wirelessmacfilter", "wirelessmacfilter", sensorSectionOptions).then(function (rv) {
                                                if (rv) {
                                                        if (rv.section) {
                                                                self.MACFilteringCommitUCISection("wirelessmacfilter").then(function (res) {
        ...
        ModeConfigSectionAdd1: function (id) {
                ...
                this.MACFilteringUCISections("wirelessmacfilter", "wirelessmacfilter").then(function (rv) {
                        ...
                        for (var key in rv) {
                                ...
                                if(networkmode==id){
                                self.ModechangeCreateUCISection("wirelessmacfilter", "wirelessmacfilter",key,sensorSectionOptions).then(function (rv) {
                                        if (rv) {
                                                if (rv.section) {
                                                        self.MACFilteringCommitUCISection("wirelessmacfilter").then(function (res) {
        ...
        MACFilteringConfigSectionRemove: function (ev) {
                ...
                self.MACFilteringDeleteUCISection("wirelessmacfilter", "wirelessmacfilter", MACID).then(function (rv) {
                        if (rv == 0) {
                                self.MACFilteringCommitUCISection("wirelessmacfilter").then(function (res) {
                                        if (res != 0) {
                                                alert("Error: Delete Configuration");
        ...
        execute: function () {
                ...
                var m = new L.cbi.Map('wirelessmacfilter', {
                });
                ...
                var m1 = new L.cbi.Map('wirelessmacfilter', {
                });
                ...
                self.MACFilteringUCISections("wirelessmacfilter", "wirelessmacfilter").then(function (rv) {
