L.ui.view.extend({
        ...
        RS485ConfigCreateForm: function (mapwidget, RS485ConfigSectionName) {
                ...
                var map = new mapwidget('macbinding', {
        ...
        RS485ConfigSectionAdd: function () {
                ...
                this.RS485GetUCISections("macbinding", "macbinding", RS485ConfigSectionName, RS485ConfigSection).then(function (rv) {
                        ...
                        if (keysLength >= 15) {
                                ...
                                self.RS485CreateUCISection("macbinding", "macbinding", RS485ConfigSectionName, RS485ConfigSection).then(function (rv) {
                                        if (rv) {
                                                if (rv.section) {
                                                        self.RS485CommitUCISection("macbinding").then(function (res) {
        ...
        RS485ConfigSectionRemove: function (ev) {
                ...
                self.RS485DeleteUCISection("macbinding", "macbinding", RS485ConfigSectionName).then(function (rv) {
                        if (rv == 0) {
                                self.RS485CommitUCISection("macbinding").then(function (res) {
                                        if (res != 0) {
        ...
        execute: function () {
                ...
                var m = new L.cbi.Map('macbinding', {
                });
                ...
                self.RS485GetUCISections("macbinding", "macbinding").then(function (rv) {
