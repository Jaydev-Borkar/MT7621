L.ui.view.extend({
    ...
    execute:function() {
        ...
        var s = m.section(L.cbi.NamedSection, 'routerapplicationlocalconfigModem1', {
            caption:L.tr('Modem 1 Local Monitor Application')
        }); 
         
             
         s.option(L.cbi.CheckboxValue, 'enablerouterlocalpingapp', {
         caption: L.tr('Enable Router Local Ping Check Application'),
         });
        ...
        s.option(L.cbi.DummyValue, 'ipaddress1', {
        ...
        s.option(L.cbi.DummyValue, 'ipaddress2', {
	   ...
	   caption: L.tr('Enable Second Level Action'),
		...
		var r = m.section(L.cbi.NamedSection, 'routerapplicationRemoteconfigModem1', {
            caption:L.tr('Modem 1 Remote Monitor Application')
        }); 
