L.ui.view.extend({
        ...
        timeActionCreateFormCallback: function() {
               ...
               /* s.taboption('action1', L.cbi.ListValue, 'a1IOCardType', {
                        caption: L.tr('IO Card Type')
                }).depends({'enable':'1','a1Type':'relay'})
                .value("AI4DIO22", L.tr("AI4DIO22"))
                .value("DIO16", L.tr("DIO16"));
                
                s.taboption('action1', L.cbi.ListValue, 'a1IOCardNo', {
                        caption: L.tr('IO Card No')
                }).depends({'enable':'1','a1Type':'relay'})
                .value("1", L.tr("IO Card 1"));
                
                s.taboption('action1', L.cbi.ListValue, 'a1AI4DIO22_RelayNo', {
                        caption: L.tr('Relay Number'),
                        description: L.tr('Please choose the relay No'),
                        optional: true
                }).depends({'enable':'1','a1Type':'relay','a1IOCardType':'AI4DIO22'})
                .value("relay1", L.tr("Relay1"))
                .value("relay2", L.tr("Relay2"))
                .value("relay3", L.tr("Relay3"))
                .value("relay4", L.tr("Relay4"));
                
                s.taboption('action1', L.cbi.ListValue, 'a1DIO16_RelayNo', {
                        caption: L.tr('Relay Number'),
                        description: L.tr('Please choose the relay No'),
                        optional: true
                }).depends({'enable':'1','a1Type':'relay','a1IOCardType':'DIO16'})
                .value("relay1", L.tr("Relay1"))
                .value("relay2", L.tr("Relay2"));
                
                s.taboption( 'action1', L.cbi.ListValue, 'a1RelayAction', {
                        caption: L.tr('Relay Action'),
                        optional: true
                }).depends({'enable':'1','a1Type':'relay'})
                .value("on", L.tr("On with Timeout"))
                .value("off", L.tr("Off with Timeout"))
                .value("onoff", L.tr("On & Off"))
                .value("continuousOn", L.tr("Continuous On"))
                .value("continuousOff", L.tr("Continuous Off"));
                
                s.taboption('action1', L.cbi.InputValue, 'a1RelayOnTimeout', {
                        caption: L.tr('On Timeout'),
                        description: L.tr('In seconds'),
			datatype:'integer',
                        initial: 30
                }).depends({'enable':'1','a1Type':'relay','a1RelayAction':'on'})
                .depends({'enable':'1','a1Type':'relay','a1RelayAction':'onoff'});
                
                s.taboption('action1', L.cbi.InputValue, 'a1RelayOffTimeout', {
                        caption: L.tr('Off Timeout'),
                        description: L.tr('In seconds'),
			datatype:'integer',
                        initial: 30
                }).depends({'enable':'1','a1Type':'relay','a1RelayAction':'off'})
                .depends({'enable':'1','a1Type':'relay','a1RelayAction':'onoff'});*/
