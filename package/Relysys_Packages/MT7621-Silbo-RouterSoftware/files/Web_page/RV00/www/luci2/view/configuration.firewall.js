L.ui.view.extend({
	...
	s.option(L.cbi.InterfaceList, 'src', {
			caption:     L.tr('Source zone'),
			optional:     true,
		...
		s.option(L.cbi.InputValue, 'src_port', {
		  ...
		  s.option(L.cbi.InterfaceList, 'dest', {
			caption:     L.tr('Destination zone'),
			optional:     true,
	...
	snSectionAdd: function () 
	{
		...
		var snDest = $('#field_firewall_snat_newSnat_dest').val();
		var SectionOptions = {name:snName,src:snSrc,dest:snDest,target:"SNAT"};
