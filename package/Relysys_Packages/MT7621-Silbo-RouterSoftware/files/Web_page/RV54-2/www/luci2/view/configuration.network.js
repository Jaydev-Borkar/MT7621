...
wifi_enable_disable:true,
	...
	s.option(L.cbi.ListValue, 'type', {
        ...
        s.option(L.cbi.ListValue, 'ipmodewan', {
          caption: L.tr('IP Modes'),
       }).depends({ 'type': 'WAN' })
          .value("IPV4", L.tr("IPV4"))
          .value("IPV6", L.tr("IPV6"));
 
       s.option(L.cbi.ListValue, 'ipmodelan', {
          caption: L.tr('IP Modes'),
       }).depends({ 'type': 'LAN' })
          .value("IPV4", L.tr("IPV4"))
          .value("IPV4+IPV6", L.tr("IPV4+IPV6"));
       ...
       s.option(L.cbi.ListValue, 'ipv6addressingmode', {
          ...
          .depends({ 'protocol_lan':'static_lan' , 'ipmodelan': 'IPV4+IPV6' });
       ...
       s.option(L.cbi.ListValue, 'ipv6relayingmode', {
          ...
          .depends({ 'ipmodelan': 'IPV4+IPV6', 'ipv6addressingmode': 'ipv6_relay' })
          .depends({ 'ipmodelan': 'IPV4+IPV6', 'ipv6addressingmode': 'ipv6_relay_hybrid' });
       ...
       s.option(L.cbi.CheckboxValue, 'ipv6defaultroute', {
          ...
          optional: true
       }).depends({ 'type': 'WAN', 'ipmodewan': 'IPV6' });
 
       s.option(L.cbi.InputValue, 'ipv6_metric', {
          caption: L.tr('IPV6 Metric'),
          datatype: 'uinteger',
       }).depends({ 'ipv6defaultroute': '1', 'type': 'WAN', 'ipmodewan': 'IPV6' });
 
       s.option(L.cbi.CheckboxValue, 'ipmodelandelegateprefix', {
          caption: L.tr('IPV6 Delegate Prefix'),
          optional: true
       }).depends({ 'ipmodewan': 'IPV6' })
          .depends({ 'ipmodelan': 'IPV4+IPV6' , 'protocol_lan':'static_lan'});
       ...
       s.option(L.cbi.ComboBox, 'ipv6delegateprefix', {
          ...
          .depends({ 'ipmodelan': 'IPV4+IPV6', 'ipmodelandelegateprefix': '1' });
       //.depends({ });
       ...
       .depends({ 'type': 'LAN', 'ipmodelan': 'IPV4+IPV6' });
       ...
       s.option(L.cbi.CheckboxValue, 'ipv6interval', {
         ...
         optional: true
            ...
            s.option(L.cbi.InputValue, 'ra_mininterval', {
               ...
               optional: 'true',
               placeholder:'30',
         }).depends({ 'ipmodelan': 'IPV4+IPV6', 'ipv6interval': '1' });
      ...
      s.option(L.cbi.CheckboxValue, 'ipv6enable_dns', {
         caption: L.tr('IPV6 Enable DNS'),
       }).depends({'ipmodelan': 'IPV4+IPV6' ,'protocol_lan':'static_lan' })
       .depends({'ipmodewan': 'IPV6'});

 
       s.option(L.cbi.DynamicList, 'ipv6dnsserver', {
          caption: L.tr('IPV6 DNS Server'),
          placeholder: "2001:0db8:85a3:0:0:8a2e:0370:7334",
          datatype: 'ip6addr',
          optional: true,
 
       }).depends({ 'ipv6enable_dns':'1','ipmodewan': 'IPV6'})
          .depends({ 'ipv6enable_dns':'1','ipmodelan': 'IPV4+IPV6' ,'protocol_lan':'static_lan' });
      ...
      s.option(L.cbi.InputValue, 'dhcpgateway', {
		...
		s.option(L.cbi.CheckboxValue, 'enable_gateway', {
           caption: L.tr('Custom Gateway (Option 3)'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
   ...
   s.option(L.cbi.DummyValue, '', {
	...
	pbRenderContents: function(rv)
	{
		...
		for (var key in rv) 
                ...
                var Modes = (obj.ipmodelan !== undefined ? obj.ipmodelan : (obj.ipmodewan !== undefined ? obj.ipmodewan : '---'));
			                
                                 list.row([Interface,PhysicalDevice,Macaddr,Type,Modes,key]); 
                        }
                }
	...
	.depends({'CellularOperationMode' : 'dualcellularsinglesim','modemenable':'1','dataenable' : '1','enablecellular':'1','pdp':'2'})
	.depends({'CellularOperationMode' : 'singlecellularsinglesim','modemenable':'1','dataenable' : '1','enablecellular':'1','pdp':'2'})
	.depends({'CellularOperationMode' : 'singlecellulardualsim','modemenable':'1','dataenable' : '1','enablecellular':'1','pdp':'2'});
	...
	// .depends({'CellularOperationMode' : 'dualcellularsinglesim','modemenable':'1','dataenable' : '1','enablecellular':'1'})
	.depends({'CellularOperationMode' : 'singlecellulardualsim','modemenable':'1','dataenable' : '1','enablecellular':'1','sim2pdp':'2'});
   ...
   var m1 = new L.cbi.Map('sysconfig', {
                });     
   
   var s1 = m1.section(L.cbi.NamedSection, 'bandlock', {
        caption:L.tr('')
    });
...
//Modem1
        ...
        s1.option(L.cbi.DummyValue, 'modem1', {
			caption: L.tr(''),
        }).depends({'band':'1'})
				.ucivalue=function()
					{
           ...
           s1.option(L.cbi.DummyValue, 'cellularmodem1', {
           caption: L.tr('Module'),
        }).depends({'band':'1'});
        
          
			 s1.option(L.cbi.ListValue, 'bandselectenable1', {         
			...
			s1.option(L.cbi.DynamicList, 'lte', {         
             ...
             s1.option(L.cbi.DynamicList, '5g', {         
       ...
       //For Modem1
          ...
          s1.option(L.cbi.CheckboxValue, 'enableoperator1', {
                    caption: L.tr('Operator Select Enable'),
                    optional: true
                  }).depends({'band':'1'});
                         
         s1.option(L.cbi.ListValue, 'selectionmode1', {         
        ...
        s1.option(L.cbi.InputValue, 'Code1', {
       ...
       self.fGetUCISections("sysconfig", "sysconfig").then(function (rv) {
            for (var key in rv) {
                if (rv.hasOwnProperty(key)) {
                    var obj = rv[key];
                    var cellularoperatormode = obj.CellularOperationMode;
                       var depends = {'modemenable':'1'};

                        if (cellularoperatormode === 'dualcellularsinglesim') {
                        depends['CellularOperationMode'] = 'dualcellularsinglesim';
                        
                 s1.option(L.cbi.DummyValue, 'modem2', {
			caption: L.tr(''),
		...
		s1.option(L.cbi.DummyValue, 'cellularmodem2', {
          caption: L.tr('Module'),
        }).depends({'CellularOperationMode' : 'dualcellularsinglesim','band':'1'});
          
         s1.option(L.cbi.ListValue, 'bandselectenable2', {         
                        caption: L.tr('Mode Selection'), 
                        optional: true                   
                }).depends({'CellularOperationMode' : 'dualcellularsinglesim','band':'1'})                               
           ...
           s1.option(L.cbi.DynamicList, '4g', {         
                        caption: L.tr('LTE Band Selection'), 
                        optional: true                   
        ...
        //For Modem2 
         ...
         s1.option(L.cbi.CheckboxValue, 'enableoperator2', {
                    caption: L.tr('Operator Select Enable'),
                    optional: true
                  }).depends({'CellularOperationMode' : 'dualcellularsinglesim','band':'1'});
                  
                   
        s1.option(L.cbi.ListValue, 'selectionmode2', {         
                    caption: L.tr('Operator Selection Mode'), 
                    optional: true                   
         ...
         s1.option(L.cbi.InputValue, 'Code2', {
                    caption: L.tr('Operator Code'),
                    optional: true 
...
if (!self.wifi_enable_disable) {
   ...
   var s2 = m2.section(L.cbi.NamedSection, 'wificonfig', {
       ...
       s2.option(L.cbi.CheckboxValue, 'InternetOverWifi', {
		...
		s2.option(L.cbi.CheckboxValue, 'wifienable_bridge', {
           caption: L.tr('Enable 2.4GHz & 5GHz Bridge'),
