...
////=========================================================================================================================================		
	  ...
	  .value("l2tp",L.tr("L2TP"));
       ...
       s.taboption('ethernetconfig',L.cbi.ListValue, 'port3IPType', {
        ...
        .depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','EthernetProtocolPort3wan':'l2tp'})
          ...
          s.taboption('ethernetconfig',L.cbi.InputValue,'port3IPaddr' , {
           caption: L.tr('WAN IP Address'),
           datatype: 'ip4addr',
        }).depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','port3IPType':'static','EthernetProtocolPort3wan':'l2tp'})
        .depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','port3IPType':'static','EthernetProtocolPort3wan':'pptp'});
        
                  
          s.taboption('ethernetconfig',L.cbi.InputValue,'port3Gateway' , {
           caption: L.tr('WAN Gateway'),
           datatype: 'ip4addr',
        }).depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','port3IPType':'static','EthernetProtocolPort3wan':'l2tp'})     
        .depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','port3IPType':'dynamic','EthernetProtocolPort3wan':'l2tp'})       
        .depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','port3IPType':'static','EthernetProtocolPort3wan':'pptp'})     
        .depends({'ethernetconfig':'1','port':'port1','port3mode' : 'EWAN3','port3IPType':'dynamic','EthernetProtocolPort3wan':'pptp'});        
                  
          s.taboption('ethernetconfig',L.cbi.InputValue,'port3Netmask' , {
...
//5G Network Configuration===================================================
               ...
               //}).depends({'CellularOperationMode' : 'dualcellularsinglesim','cellularmodem1':'QuectelRM500Q','cellularconfig':'1','enablecellular':'1'})
                ...
                //}).depends({'cellularconfig':'1'})
                  //.depends({'enablecellular':'1','rattype1':'NR5G'})
                  //.depends({'enablecellular':'1','rattype1':'AUTO'})
                  //.depends({'enablecellular':'1','rattype1':'LTE:NR5G'})
...
//=====================================================================				
      ...
      s.tab({
            id: 'band',
            caption: L.tr('Band and Operator Lock')
        });
		
		//Modem1
          
                    	s.taboption('band',L.cbi.DummyValue, 'modem1', {
			caption: L.tr(''),
        }).depends({'band':'1'})
				.ucivalue=function()
					{
           ...
           s.taboption('band',L.cbi.DummyValue, 'cellularmodem1', {
           caption: L.tr('Module'),
        }).depends({'band':'1'});
        
          
			 s.taboption('band',L.cbi.ListValue, 'bandselectenable1', {         
			...
			s.taboption('band',L.cbi.DynamicList, 'lte', {         
             ...
             s.taboption('band',L.cbi.DynamicList, '5g', {         
       ...
       //For Modem1
          ...
          s.taboption('band',L.cbi.CheckboxValue, 'enableoperator1', {
                    caption: L.tr('Operator Select Enable'),
                    optional: true
                  }).depends({'band':'1'});
                         
         s.taboption('band',L.cbi.ListValue, 'selectionmode1', {         
         ...
         s.taboption('band',L.cbi.InputValue, 'Code1', {
        ...
        //Modem2
                    	...
                    	s.taboption('band',L.cbi.DummyValue, 'modem2', {
			caption: L.tr(''),
		...
		s.taboption('band',L.cbi.DummyValue, 'cellularmodem2', {
          caption: L.tr('Module'),
        }).depends({'CellularOperationMode' : 'dualcellularsinglesim','band':'1'});
          
          s.taboption('band',L.cbi.ListValue, 'bandselectenable2', {         
                        caption: L.tr('Mode Selection'), 
                        optional: true                   
                }).depends({'CellularOperationMode' : 'dualcellularsinglesim','band':'1'})                               
           ...
           s.taboption('band',L.cbi.DynamicList, '4g', {         
                        caption: L.tr('LTE Band Selection'), 
                        optional: true                   
        ...
        //For Modem2 
         ...
         s.taboption('band',L.cbi.CheckboxValue, 'enableoperator2', {
                    caption: L.tr('Operator Select Enable'),
                    optional: true
                  }).depends({'CellularOperationMode' : 'dualcellularsinglesim','band':'1'});
                  
                   
         s.taboption('band',L.cbi.ListValue, 'selectionmode2', {         
                    caption: L.tr('Operator Selection Mode'), 
                    optional: true                   
         ...
         s.taboption('band',L.cbi.InputValue, 'Code2', {
                    caption: L.tr('Operator Code'),
                    optional: true 
 ...
 //=================================wificonfig settings ========================================
     //WIFI 5 Settings
       ...
       s.taboption('wificonfig',L.cbi.CheckboxValue, 'wifi1enable', {
		...
		s.taboption('wificonfig',L.cbi.InputValue, 'wifistassid', {
		caption: L.tr('Client SSID'), 
		}).depends({'wificonfig':'1','wifi1enable':'1','wifi1mode' : 'sta'})
		.depends({'wificonfig':'1','wifi1enable':'1','wifi1mode' : 'apsta'});
		
		s.taboption('wificonfig', L.cbi.PasswordValue, 'wifistakey', {
		...
		s.taboption('wificonfig', L.cbi.InputValue, 'wifistaauth', {
		caption:        L.tr('Client Radio Authentication'),
		optional:	true
		}).depends({'wificonfig':'1','wifi1enable':'1','wifi1mode' : 'sta'})
		.depends({'wificonfig':'1','wifi1enable':'1','wifi1mode' : 'apsta'});

		s.taboption('wificonfig', L.cbi.InputValue, 'wifistaencryption', {
