...
echo "Please wait while the MAC address is updating..."

uci set network.LAN1.macaddr="$lan1_mac_addr"
uci set network.LAN2.macaddr="$lan2_mac_addr"
uci set network.LAN3.macaddr="$lan3_mac_addr"
uci set network.LAN4.macaddr="$lan4_mac_addr"
